...
EXTERN_C DWORD LCAN_OpenDevice(UINT devType, UINT devIndex);
EXTERN_C DWORD LCAN_CloseDevice(UINT devType, UINT devIndex);
EXTERN_C DWORD LCAN_GetReceiveNum(UINT devType,UINT devIndex,UINT canIndex,UCHAR type);
EXTERN_C DWORD LCAN_Receive(UINT devType,UINT devIndex,UINT canIndex,PLCAN_CAN_OBJ pReceive,UINT len,INT waitTime);
EXTERN_C DWORD LCAN_ReceiveFD(UINT devType,UINT devIndex,UINT canIndex,PLCAN_CANFD_OBJ pReceive,UINT len,INT waitTime);
EXTERN_C DWORD LCAN_Transmit(UINT devType,UINT devIndex,UINT canIndex,PLCAN_CAN_OBJ pSend,UINT len);
EXTERN_C DWORD LCAN_TransmitFD(UINT devType,UINT devIndex,UINT canIndex,PLCAN_CANFD_OBJ pSend,UINT len);
EXTERN_C DWORD LCAN_InitCAN(UINT devType, UINT devIndex, UINT canIndex, PLCAN_INIT_CONFIG pInitConfig);
EXTERN_C DWORD LCAN_InitCANFD(UINT devType, UINT devIndex, UINT canIndex, PLCAN_INITFD_CONFIG pInitConfig);
EXTERN_C DWORD LCAN_SetFliter(UINT devType, UINT devIndex, UINT canIndex, PLCAN_FLITER_CONFIG pFliterConfig);
#endif
