...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SPI1_BL_Pin|SPI1_CS_Pin|SPI1_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, RGB_B_Pin|RGB_G_Pin|RGB_R_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SPI1_BL_Pin|SPI1_CS_Pin|SPI1_DC_Pin;
